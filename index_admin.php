...
<html>
   ...
   <body>
      <nav>
         ...
         <a class="buttons" href="product.php"> Product</a>
         <a class="buttons" href="user.php">User</a>
         ...
         <ul>
            <li id="myProduct">
               <div class="product">
                  ...
                  <a href="#" class="image"><img src="images/ijersey(1).jpeg" alt="Jersey Image Here"></a>
